...
from Exceptions import WAExceptionDataPlugin, WAExceptionDataPluginTypes
...
class IDataProcessor:
	...
	def ReturnAlerts(self):
		return self._XAlertData
		
	def ReturnConditions(self):
		output = {}
	...
	def _DownloadContent(self):
		try:
			...
			raise WAExceptionDataPlugin(WAExceptionDataPluginTypes.DownloadError, self.RemoteDataUrl)
			return False
